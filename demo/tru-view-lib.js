            ...
            function ($templateCache) {
                return {
                    ...
                    link: function (scope, element, attrs, ctrl) {
                        ...
                        scope.$watch('field.property.labelPosition', function (newValue) {
                            if (newValue === 'none') {
                                ...
                                container.addClass('tvl-container-dat-none');
                                containerLabel.addClass('tvl-container-dat-label-none');
                                containerContent.addClass('tvl-container-dat-content-none');
                            }
                            if (newValue === 'top') {
                                container.removeClass('tvl-container-dat');
                                containerLabel.removeClass('tvl-container-dat-label');
...
angular.module('tru.view.lib').run(['$templateCache', function($templateCache) {
    ...
    $templateCache.put('src/templates/tru-search-group.html',
        ...
        "\n" +
        "    <div class=\"tvl-search-group-button-wrapper\">\r" +
        "\n" +
        ...
        "\n" +
        "                class=\"tvl-btn tvl-btn-primary\"\r" +
        "\n" +

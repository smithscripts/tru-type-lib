(function() {
    "use strict";
    describe('std-decimal-query', function() {
        var compile,
            doc,
            scope,
            timeout,
        ...
        var compileAndAppendElement = function() {
            ...
            var elm = angular.element('<std-decimal-query label="Foo Bar" field="searchFields.Field1"></std-decimal-query>');
            elm.appendTo(searchGroup);
            elm = compile(elm)(scope);
            scope.$digest();

            isoScope = elm.isolateScope();
            ctrl = elm.controller('stdDecimalQuery');
        };
        ...
        beforeEach(module('std.decimal.query'));

        beforeEach(inject(function ($rootScope, $templateCache, $compile, $timeout, queryDataModel) {
            $templateCache.put('src/templates/query/std-decimal-query.html', __html__['src/templates/query/std-decimal-query.html']);
        ...
        describe('precision', function() {
            it('when decimalPlaces is 5 input should not allow a 6th decimal place', function () {
                dataModel.decimalPlaces = 5;
                dataModel.defaultValue = 1.12345;
                compileAndAppendElement();
                var input = document.getElementsByTagName('input')[0];
                input.focus();
            ...
            it('when decimalPlaces is 30 input should not allow a 9 whole number', function () {
                dataModel.decimalPlaces = 30;
                dataModel.defaultValue = 12345678.12345;
                compileAndAppendElement();
                var input = document.getElementsByTagName('input')[0];
                input.focus();

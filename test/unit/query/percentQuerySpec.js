(function() {
    "use strict";
    describe('std-percent-query', function() {
        var compile,
            doc,
            scope,
            timeout,
        ...
        var compileAndAppendElement = function() {
            ...
            var elm = angular.element('<std-percent-query label="Foo Bar" field="searchFields.Field1"></std-percent-query>');
            elm.appendTo(searchGroup);
            elm = compile(elm)(scope);
            scope.$digest();

            isoScope = elm.isolateScope();
            ctrl = elm.controller('stdPercentQuery');
        };
        ...
        beforeEach(module('std.percent.query'));

        beforeEach(inject(function ($rootScope, $templateCache, $compile, $timeout, $document, queryDataModel) {
            $templateCache.put('src/templates/query/std-percent-query.html', __html__['src/templates/query/std-percent-query.html']);

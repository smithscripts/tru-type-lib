(function() {
    "use strict";
    describe('std-usa-dollar-edit', function() {
        var compile,
            doc,
            scope,
            timeout,
        ...
        var compileAndAppendElement = function() {
            ...
            var elm = angular.element('<std-usa-dollar-edit label="Foo Bar" field="fields.Field1"></std-usa-dollar-edit>');
            element = compile(elm)(scope);
            element.appendTo(document.body);
            scope.$digest();
            isoScope = element.isolateScope();
            ctrl = element.controller('stdUsaDollarEdit');
        };

        beforeEach(module('edit.data.model'));
        beforeEach(module('std.usa.dollar'));
        beforeEach(module('std.usa.dollar.edit'));
        ...
        beforeEach(inject(function ($rootScope, $templateCache, $compile, editDataModel) {
            $templateCache.put('src/templates/edit/std-usa-dollar-edit.html', __html__['src/templates/edit/std-usa-dollar-edit.html']);

(function() {
    "use strict";
    describe('std-float-edit', function() {
        var compile,
            doc,
            scope,
            timeout,
        ...
        var compileAndAppendElement = function() {
            ...
            var elm = angular.element('<std-float-edit label="Foo Bar" field="fields.Field1"></std-float-edit>');
            element = compile(elm)(scope);
            element.appendTo(document.body);
            scope.$digest();
            isoScope = element.isolateScope();
            ctrl = element.controller('stdFloatEdit');
        };

        beforeEach(module('edit.data.model'));
        beforeEach(module('std.float'));
        beforeEach(module('std.float.edit'));
        ...
        beforeEach(inject(function ($rootScope, $templateCache, $compile, editDataModel) {
            $templateCache.put('src/templates/edit/std-float-edit.html', __html__['src/templates/edit/std-float-edit.html']);
        ...
        describe('float', function() {
            ...
            it('should not allow non-float values', function () {
                dataModel.value = 1.2345;
                compileAndAppendElement();
                var input = document.getElementsByTagName('input')[0];
